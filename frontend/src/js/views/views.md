...
- To set up a new view, afterwards, create your view.js file, implementing this interface, then change viewManager.js.
    - In the object views, add a value for your view, starting with the '#' character.
    - In initViews, create a new instance of your specified view in each of the switch statements, and add a new switch statement for your new view.
